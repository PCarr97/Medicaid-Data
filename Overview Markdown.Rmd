...
Unfortunately, this dataset is not particularly robust, with only seven data points per metric, per year. However, we can see that after 2013, the trend of declining assets and increasing debt appears to have been disrupted.
