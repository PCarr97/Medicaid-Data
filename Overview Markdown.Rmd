...
The following data trends will attempt to identify trends that may have been driven by this leap upwards to 138%, with the blue dashed line signifying the imlementation of the increased eligibility limit.
...
We would expect Medicaid expansion to have na impact on the personal finances of the poorest Americans given (1) the increased financial security and reduced risk of medical bankruptcy for those with health insurance as opposed to the uninsured, and (2) the presences of state-imposed asset ceilings restricting Medicaid eligibility regardless of one's income. 

Unfortunately, this dataset only contains seven data points per metric, per year, which does not give us a particularly thorough understanding of the trend. However, we can see that after 2013, the trend of declining assets and increasing debt appears to have been disrupted.
